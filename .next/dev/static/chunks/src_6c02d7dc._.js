...
function ThemeProvider({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ThemeProvider.useEffect": ()=>{
            ...
            const apply = {
                "ThemeProvider.useEffect.apply": (dark)=>{
                    document.documentElement.classList.remove('light', 'dark');
                    document.documentElement.classList.add(dark ? 'dark' : 'light');
                }
            }["ThemeProvider.useEffect.apply"];
            const handler = {
                "ThemeProvider.useEffect.handler": (e)=>apply(e.matches)
...
_s(ContactModal, "j88n+qteNRv9HYNj6klOFCiB5wU=");
_c = ContactModal;
var _c;
...
_s1(ContactModalProvider, "BTncbWj45JCnjfHmg9BxSX39Oec=");
...
//# sourceMappingURL=src_6c02d7dc._.js.map