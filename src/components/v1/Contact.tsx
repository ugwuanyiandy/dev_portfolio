...
export default function Contact() {
    return (
        <section id="contact" className="py-20 bg-[#FAFAFA] dark:bg-gray-900">
            <div className="max-w-[1200px] mx-auto px-6 lg:px-8">
                <div className="max-w-2xl mx-auto text-center">
                    <h2 className="text-[32px] lg:text-[40px] font-bold text-gray-900 dark:text-white mb-4">
                        Let's Work Together
                    </h2>
                    <p className="text-gray-600 dark:text-gray-300 mb-10 text-[17px]">
                        I'm currently open to new opportunities, questions, and mentorship requests.
                        Just want to say hello? Go ahead!
                    </p>

                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
                        <a
                            href="mailto:christaindrew@gmail.com?subject=Contact mail from online portfolio"
                        ...
                        <a
                            href="tel:+2347036784887"
                            className="inline-flex items-center gap-2.5 border-2 border-gray-900 dark:border-white text-gray-900 dark:text-white px-7 py-3.5 rounded-full text-[15px] font-medium hover:bg-gray-900 hover:text-white dark:hover:bg-white dark:hover:text-gray-900 transition-colors"
                        >
                    ...
                    <div className="flex items-center justify-center gap-4">
                        <a
                            ...
                            className="w-12 h-12 rounded-full bg-white dark:bg-gray-800 shadow-sm flex items-center justify-center text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:shadow-md transition-all"
                            aria-label="Twitter"
                        >
